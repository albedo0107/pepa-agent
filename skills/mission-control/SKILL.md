...
| GET `?action=capabilities` | viewer | Feature flags |
...
- `mission-control-installer` — Install MC on a new machine
- `mission-control-manage` — Health checks, diagnostics, upgrades, backups
